...
//////////////////////////////////////////////////////////////////////////////
//Every valid Windows PE file must begin with an MS-DOS stub.
// That’s the MZ header + some code that normally just prints :
//      "This program cannot be run in DOS mode."
// 
//      static const BYTE s_rbDosCode[] = {
